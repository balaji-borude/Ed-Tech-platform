...
const About = () => {
  return (
    <div className="text-white bg-[#161D29] ">
      ...
      {/* section-2 */}
      <section className="border-b border-richblack-700 mb-10">
      ...
      {/* section 5 */}
      <section className="mx-auto flex flex-col mt-40 justify-between items-center gap-5 lg:mb-[150px]">
        <LearningGrid />
        <ContactFormSection />
      </section>
