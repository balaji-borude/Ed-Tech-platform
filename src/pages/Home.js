  ...
  return (
    <div className="h-auto">
      ...
      <div className="relative mx-auto mt-16 flex flex-col w-11/12 max-w-maxContent items-center text-white justify-between">
        ...
        {/* Video section */}
        <div className="relative w-full max-w-5xl my-12 shadow-blue-200 shadow-2xl rounded-xl overflow-hidden">
          <video
        ...
        <div>
          <CodeBlocks
            position={"flex flex-col w-full bg-pink-500 sm:flex-row"}
            heading={
