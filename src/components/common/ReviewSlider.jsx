...
const ReviewSlider = () => {
  ...
  return (
    <div className="text-white py-10 bg-richblack-900">
      <h2 className="text-2xl font-semibold text-center mb-8">
        Student <span className="text-yellow-400">Reviews</span>
      </h2>

      <div className="h-[260px] max-w-maxContent px-6">
<Swiper
  loop={true}
  freeMode={true}
  autoplay={{ delay: 3000 }}
...
>
  {reviews.map((review, index) => (
    <SwiperSlide key={index}>
      <div className="w-[280px] bg-richblack-800 p-5 rounded-2xl shadow-md flex flex-col justify-between hover:scale-105 transition-transform duration-300">
        {/* User Info */}
